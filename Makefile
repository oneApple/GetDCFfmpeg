...
OBJS        = $(addsuffix .o,          $(PROGS-yes)) cmdutils.o  src/watermark.o
...
%_g$(EXESUF): %.o cmdutils.o  src/watermark.o $(FF_DEP_LIBS)
	$(LD) $(FF_LDFLAGS) -o $@ $< cmdutils.o src/watermark.o $(FF_EXTRALIBS)
#LD=gcc
